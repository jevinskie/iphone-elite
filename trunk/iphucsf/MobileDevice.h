...
typedef void (*am_dfu_device_notification_callback)(struct
													am_dfu_device *);
...
unsigned int AMRestoreRegisterForDeviceNotifications(
    am_dfu_device_notification_callback dfu_connect_callback,
    am_restore_device_notification_callback recovery_connect_callback,
    am_dfu_device_notification_callback dfu_disconnect_callback,
...
/* 0p: No frickin clue */
unsigned int AMRestorePerformDFURestore(struct am_dfu_device *rdev,
										CFDictionaryRef opts, void *callback,
										void *user_info);
